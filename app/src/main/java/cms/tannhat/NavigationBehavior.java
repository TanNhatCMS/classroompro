...
public class NavigationBehavior<V extends View>  extends CoordinatorLayout.Behavior<V> {
    ...
    @Override
    public void onNestedPreScroll (@NonNull CoordinatorLayout coordinatorLayout, @NonNull V child, View target, int dx, int dy, @NonNull int[] consumed, int type) {
