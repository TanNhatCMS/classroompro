...
public class GetAsyncURL extends AsyncTask<Void, Void, Void> {
    ...
    public GetAsyncURL(ShubActivity mainActivity, Context context, IndexFastScrollRecyclerView rv, String code) {
        super(mainActivity);
