package cms.tannhat.classroompro.firebase;
...
public class UpdateTimeTable {
    ...
    private static final String TAG = UpdateTimeTable.class.getSimpleName();
    ...
    public UpdateTimeTable(@NonNull Context context,
    ...
    public static class Builder {
        ...
        public UpdateTimeTable build() {
            return new UpdateTimeTable(context, onUpdateNeededListener);
        }

        public UpdateTimeTable check() {
            UpdateTimeTable forceUpdateChecker = build();
